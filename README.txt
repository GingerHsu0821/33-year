    ...
    <body>
        <div id="main">
            ...
            <div id="wrap">
                <div id="text">
			        <div id="code">
			        	<span class="say">* 致蔡喬伊： *</span><br>
						<span class="say"> </span><br>
			        	<span class="say">· 蔡喬伊，二周年快樂！</span><br>
						<span class="say"> </span><br>
                        <span class="say">· 不經意的相識, 或許是缘分，或許是注定的。</span><br>
						<span class="say"> </span><br>
			        	<span class="say">· 雖然我不帥，但我願意什麼都給你！</span><br>
						<span class="say"> </span><br>
			        	<span class="say">· 虽然我不好，但我也在讓自己更好！</span><br>
						<span class="say"> </span><br>
			        	<span class="say">· 虽然我很白目，但我盡力在改變！</span><br>
						<span class="say"> </span><br>
			        	<span class="say">· 這一年是我們變化最大的一年</span><br>
						<span class="say"> </span><br>
			        	<span class="say">· 如論如何，我都很謝謝你一直陪著我，我会一直陪着你。</span><br>
                        <span class="say"> </span><br>
                        <span class="say">· You are my angel.</span><br>
						<span class="say"> </span><br>
						<span class="say">· I love you,蔡喬伊!</span><br>
						<span class="say"> </span><br>
                        <span class="say"><span class="space"></span>--@author 許富翔--</span>
			        </div>
                </div>
                <div id="clock-box">
                    <span class="STYLE1">现在是</span>許富翔 <span class="STYLE1" style="color: red">❤</span> 蔡喬伊<span class="STYLE1" style="color: red">相恋</span>
                  <div id="clock"></div>
              </div>
    ...
    (function(){
       ...
       //下面修改起始日期
        var textAnimate = eval(Jscex.compile("async", function () {
		    ...
		    together.setFullYear(2020, 2, 11); 			//时间年月日 月份0~11
		    together.setHours(23);						//小时
		    together.setMinutes(59);					//分钟
